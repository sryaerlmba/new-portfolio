...
const badges = {
  ...
  certifications: [
    ...
    {
      year: '2023-2025',
      title: 'Multimedia Services - Badan Nasional Sertifikasi Profesi',
    },
  ],
  awards: {
        ...
        <div class="border p-5 border-gray-400 rounded-1xl flex h-full flex-col justify-between shadow-lg">
          <div>
            ...
            <div
              ...
              v-for="(item, index) in badges.certifications"
            >
              <Badge :text="item.year" class="whitespace-nowrap" />
