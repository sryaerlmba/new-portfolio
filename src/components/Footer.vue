<template>
  <footer class="bg-gray-900 text-white py-12 px-5">
    <div
      class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left"
    >
      ...
      <div class="flex flex-col items-center">
        ...
        <div class="flex space-x-5 mb-4">
          <a
            ...
            class="text-gray-300 hover:text-blue-400 transition duration-300"
          >
            <svg
              role="img"
              viewBox="0 0 24 24"
            ...
            >
              ...
              <path
                d="M20.447 20.452h-3.554v-5.918c0-1.466-.027-3.354-2.042-3.354-2.047 0-2.361 1.591-2.361 3.242v5.909h-3.555V8.573h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.461v6.253zM5.337 7.003c-1.144 0-2.072-.929-2.072-2.072s.928-2.072 2.072-2.072 2.072.929 2.072 2.072-.929 2.072-2.072 2.072zm1.788 13.449H3.549V8.573h3.576v11.879zM22.227 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.455c.978 0 1.773-.773 1.773-1.729V1.729C24 .774 23.205 0 22.227 0z"
              />
            </svg>
          </a>
          <a
          ...
          >
            ...
            >
              <title>GitHub</title>
              <path
                d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.73.084-.73 1.205.084 1.838 1.238 1.838 1.238 1.07 1.835 2.809 1.305 3.49.998.108-.77.42-1.305.762-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1-.322 3.3-.123 1.9-.532 3.87-.532 5.77 0 2.29-2.26 3.29-.123 3.29-.123.645 1.653.24 2.873.12 3.176.77 1.22 1.233 2.3 1.233 3.22 0 4.61-2.802 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12z"
              />
            </svg>
          </a>
          <a
    ...
    <div class="text-center text-xs text-gray-500 mt-4">
      © {{ new Date().getFullYear() }} Surya Erlamba. All rights reserved.
    </div>
  </footer>
</template>
