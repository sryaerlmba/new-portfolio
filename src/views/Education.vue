        ...
        <div class="border p-5 border-gray-400 rounded-1xl shadow-lg" data-aos="fade-left">
          <div class="flex sm:gap-20 flex-col sm:flex-row">
            ...
            <div>
              ...
              <Badge text="GPA: 3.84/4.00" class="mt-3" />
              <div class="px-5">
                <ul
                  class="mt-3 text-gray-600 list-disc list-outside space-y-2 leading-relaxed text-sm md:text-base"
                >
                  <li>Recipient of the BRI Institute Cemerlang Scholarship (Minimum GPA: 3.00)</li>
                  <li>
                    Banking Courses: Accounting, Microfinance, Business Mathematics, Basic Banking
                  </li>
                  <li>
                    Information Systems and Technology Courses: Programming Algorithms, Information
                    Systems Analysis, Information and Communication Technology, Discrete Mathematics,
                    Cyber Security, Statistics (Python), Object Oriented Programming (Java), Databases
                    (SQL), Digital Marketing, English, Privacy and Data Protection, Organization and
                    Computer Architecture, Web Programming (PHP), Financial Technology, Research
                    Methodology, Management Information System, Risk Management
                  </li>
                </ul>
              </div>
            </div>
